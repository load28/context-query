...
export function EmployeeList() {
  const [searchQuery, setSearchQuery] = useContextAtom("searchQuery");
  const [selectedDeptId, setSelectedDeptId] = useContextAtom(
    "selectedDepartmentId"
  );
  const [statusFilter, setStatusFilter] = useContextAtom(
    "selectedStatusFilter"
  );
  const filteredEmployees = useContextAtomValue("filteredEmployees");
  const departments = useContextAtomValue("departments");
  const setCurrentView = useContextSetAtom("currentView");
  const setSelectedEmployeeId = useContextSetAtom("selectedEmployeeId");
  const setFormMode = useContextSetAtom("formMode");
  const setEditingEmployee = useContextSetAtom("editingEmployee");
  const setEmployees = useContextSetAtom("employees");
  const employees = useContextAtomValue("employees");
